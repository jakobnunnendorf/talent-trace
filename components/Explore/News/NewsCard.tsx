...
export default function NewsCard({
  ...
  return (
    <div className="rborder grid h-96 grid-rows-6 overflow-hidden rounded-xl bg-white shadow-lg lg:h-[420px] lg:grid-rows-5">
      <figure className="bborder relative row-span-3">
        <Image
          src={imageLink}
          alt={imageLink}
          fill
      ...
      <div className="gborder row-span-3 grid grid-rows-4 p-4 lg:row-span-2">
