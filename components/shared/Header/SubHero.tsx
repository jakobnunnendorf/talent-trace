        ...
        {primaryButton || secondaryButton ? (
          <div className="mt-12 grid grid-cols-1 grid-rows-2 gap-2 md:grid-cols-2 md:grid-rows-1 md:gap-4">
            ...
            {secondaryButton && (
              <Button
                asChild
                className="mr-auto w-full max-w-sm rounded border-2 border-white bg-transparent px-1 py-3 font-semibold transition hover:bg-white hover:text-blue md:px-6"
              >
